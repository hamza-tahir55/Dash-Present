...
class MockAiohttpResponse:
    def __init__(self, status=200, json_data=None):
        self.status = status
        self._json_data = json_data or {"path": "/Users/hamzatahir/Downloads/presenton-main/servers/nextjs/exports1/test.pdf"}
...
class TestPresentationGenerationAPI:
    def test_generate_presentation_export_as_pdf(self, client):
        response = client.post(
            "http://127.0.0.1:8000/api/v1/ppt/presentation/generate",
            json={
