          ...
          <div className="flex-1 px-8 pt-8">
            ...
            <div className="flex items-center justify-end mb-4 space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-600">{chartConfig.series3.label}</span>
              </div>
            </div>
            ...
            {chartData && chartData.length > 0 && (
              <div className="h-64">
                {/* Update chart labels based on data if available */}
                {(() => {
                  if (chartData[0] && chartData[0].name) {
                    // Only update if the data has meaningful names
                    chartConfig.series1.label = chartData[0].name;
                    if (chartData.length > 1) chartConfig.series2.label = chartData[1].name;
                    if (chartData.length > 2) chartConfig.series3.label = chartData[2].name;
                  }
                  return null;
                })()}
                <ChartContainer config={chartConfig} className="h-full w-full">
                  ...
                  >
                    ...
                    <Line
                      ...
                      stroke="#0e68b3"
                      strokeWidth={3}
                      dot={{ fill: "#0e68b3", strokeWidth: 2, r: 4 }}
                    />
                    <Line
                      type="monotone"
                      dataKey="series2"
                      stroke="#32bbd8"
                      strokeWidth={3}
                      dot={{ fill: "#32bbd8", strokeWidth: 2, r: 4 }}
                    />
                    <Line
                      type="monotone"
                      dataKey="series3"
                      stroke="#061551"
                      strokeWidth={3}
                      dot={{ fill: "#061551", strokeWidth: 2, r: 4 }}
                    />
                  </LineChart>
                </ChartContainer>
              </div>
